...
const METHOD = {
  ...
  BestLongSideFit: MaxRectsBinMethod.BEST_LONG_SIDE_FIT,
  BestAreaFit: MaxRectsBinMethod.BEST_AREA_FIT,
  BottomLeftRule: MaxRectsBinMethod.BOTTOM_LEFT_RULE,
  ContactPointRule: MaxRectsBinMethod.CONTACT_POINT_RULE,
};

export default class MaxRectsBin extends Packer {
  usedRectangles: Rect[];
  freeRectangles: Rect[];
  binWidth: number;
  binHeight: number;
  ...
  insert2(rectangles: any[], method: string) {
    let res = [];
  ...
  _scoreRectangle(width: number, height: number, method: string, score1: { value: number }, score2: { value: number }) {
    let newNode = new Rect();
  ...
  _findPositionForNewNodeBottomLeft(width: number, height: number, bestY: { value: number }, bestX: { value: number }) {
  ...
  _findPositionForNewNodeBestShortSideFit(width: number, height: number, bestShortSideFit: { value: number }, bestLongSideFit: { value: number }) {
    let freeRectangles = this.freeRectangles;
    let bestNode = new Rect();
  ...
  _findPositionForNewNodeBestLongSideFit(width: number, height: number, bestShortSideFit: { value: number }, bestLongSideFit: { value: number }) {
    let freeRectangles = this.freeRectangles;
    let bestNode = new Rect();
  ...
  _findPositionForNewNodeBestAreaFit(width: number, height: number, bestAreaFit: { value: number}, bestShortSideFit: {value: number}) {
    let freeRectangles = this.freeRectangles;
    let bestNode = new Rect();
  ...
  static getMethodByType(type): MaxRectsBinMethod {

class Trimmer {
  ...
  static getAlpha(data: Uint8Array, width: number, x: number, y: number): number {
    return data[((y * (width * 4)) + (x * 4)) + 3];
  }

  static getLeftSpace(data: Uint8Array, width: number, height: number, threshold: number = 0): number {
    let x = 0;
  ...
  static getRightSpace(data: Uint8Array, width: number, height: number, threshold: number = 0): number {
    let x = 0;
  ...
  static getTopSpace(data: Uint8Array, width: number, height: number, threshold: number = 0): number {
    let y = 0;
  ...
  static getBottomSpace(data: Uint8Array, width: number, height: number, threshold: number = 0): number {
    let y = 0;
  ...
  static trim(rects: any[], threshold: number = 0): void {
